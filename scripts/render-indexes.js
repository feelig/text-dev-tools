...
function renderHome() {
  ...
  <main>
    <section class="hero">
      <div class="container">
        <h1>Free Text & Developer Tools for Everyday Cleanup, Formatting, and Conversion</h1>
        <p>Use simple online tools to remove line breaks, clean extra spaces, count words, format JSON, and handle other common text and developer tasks directly in your browser.</p>
    ...
    <section class="section">
      <div class="container">
        <div class="ad-slot">Homepage Ad Slot 1</div>
      </div>
    </section>
...
${popular}
    ...
    <section class="section" id="categories">
      <div class="container">
        <div class="section-head">
          ...
          <p>Clear categories help users find the right tool faster and make the site structure easier to scale.</p>
        </div>
    ...
    <section class="section">
      <div class="container">
        <div class="ad-slot">Homepage Ad Slot 2</div>
      </div>
    </section>
